...
//删除学生信息
import  DelStudent from  './modules/delStudent'
//搜索
import  DelTeacher from  './modules/delTeacher'
...
const delStudent = new DelStudent()
const delTeacher =new DelTeacher()
const addTeacher = new AddTeacher()
